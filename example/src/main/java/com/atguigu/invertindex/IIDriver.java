...
public class IIDriver {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        FileInputFormat.setInputPaths(job1, new Path("d:\\HadoopTest\\example1\\input"));
        FileOutputFormat.setOutputPath(job1, new Path("d:\\HadoopTest\\example1\\output"));
        ...
        if (b) {
            ...
            FileInputFormat.setInputPaths(job2, new Path("d:\\HadoopTest\\example1\\output"));
            FileOutputFormat.setOutputPath(job2, new Path("d:\\HadoopTest\\example1\\output2"));
